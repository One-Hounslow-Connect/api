...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'eligibility_types.age_group' => ['sometimes', 'array'],
            'eligibility_types.disability' => ['sometimes', 'array'],
            'eligibility_types.employment' => ['sometimes', 'array'],
            'eligibility_types.gender' => ['sometimes', 'array'],
            'eligibility_types.housing' => ['sometimes', 'array'],
            'eligibility_types.income' => ['sometimes', 'array'],
            'eligibility_types.language' => ['sometimes', 'array'],
            'eligibility_types.ethnicity' => ['sometimes', 'array'],
            'eligibility_types.other' => ['sometimes', 'array'],

            'eligibility_types.age_group.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.disability.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.employment.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.gender.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.housing.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.income.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.language.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.ethnicity.custom' => ['nullable', 'string', 'min:1', 'max:255'],
            'eligibility_types.other.custom' => ['nullable', 'string', 'min:1', 'max:255'],
